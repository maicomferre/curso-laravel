        ...
        <div class="card-body register-card-body">
            ...
            <form action="{{ route('register.store') }}" method="post">
                ...
                <div class="input-group mb-3">
                    ...
                    @error('name')
                        <div class="invalid-feedback">Nome incorretamente inválido</div>
                    @enderror
                </div>
                <div class="input-group mb-3">
                    ...
                    @error('email')
                    <div class="invalid-feedback">O email deve ser digitado decentemente</div>
                    @enderror
                </div>
                <div class="input-group mb-3">
                    ...
                    @error('password')
                    <div class="invalid-feedback">Digite uma senha decente</div>
                    @enderror
                </div>
                <div class="input-group mb-3">
